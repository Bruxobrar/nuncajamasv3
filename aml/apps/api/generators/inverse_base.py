...
GENERATOR_ID = "lampbase1"
GENERATOR_LABEL = "LampBase1"
...
def suggest_defaults(
    ...
    if str(mount.get("source") or "") == "footprint":
        female_id = max(28.0, min(58.0, female_id * 0.58))
    ...
    support_span = max(lower_outer, upper_outer * 0.92, female_id * 1.08)

    base_radius = max(female_id * 0.9, lamp_radius * 0.6, support_span * 0.52) + 14.0
    stem_outer_diameter = max(18.0, female_id * 0.58, lower_outer * 0.68)
