...
function applyPayloadToState(payload) {
  ...
  document.getElementById("closeTopInput").checked = supportsModes ? Boolean(payload.close_top) : false;
  document.getElementById("domeModeSelect").value =
    supportsModes && payload.dome_mode === "perforated" ? "perforated" : "solid";
  syncModeControls();
}
...
function syncModeControls() {
  ...
  document.getElementById("closeTopInput").disabled = !supportsModes;
  document.getElementById("domeModeSelect").disabled = !supportsModes;
}
...
async function requestPreview() {
  ...
  try {
    ...
    meshStats.textContent = `${state.engineId} | ${data.mesh.vertex_count} vertices | ${data.mesh.triangle_count} triangles | preview`;
